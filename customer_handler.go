...
import (
	...
	"github.com/murali0706/customer/domain"
)

// Rreseponse error struct
type ResponseError struct {
	Message string `json:"message"`
}

//httphandler for customer
...
//  customer by given request body
...
// update the customer by given request body
func (a *CustomerHandler) Update(c echo.Context) (err error) {
	...
	return c.JSON(http.StatusCreated, "Data upgraded")
}
